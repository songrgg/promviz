...
func (h *handler) Run(g prometheus.Gatherer) error {
	...
	c := cors.New(cors.Options{
		AllowedOrigins: []string{
			"https://payhub.dev.booking.com",
			"https://payhub.dqs.booking.com",
			"https://payhub.prod.booking.com",
			"https://grafana.booking.com",
			"https://kuhub.dev.booking.com",
			"https://kuhub.dqs.booking.com",
			"https://kuhub.prod.booking.com",
			"*",
		},
	})
